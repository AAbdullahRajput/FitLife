...
// ══════════════════════════════════════════════════════════════════════════════
// BENCH PRESS SCREEN
// Standalone screen for Bench Press — all data, variations, video, tips here.
// ══════════════════════════════════════════════════════════════════════════════

class BenchPressScreen extends StatefulWidget {
  final String userTier; // 'guest', 'free', 'premium'

  const BenchPressScreen({super.key, required this.userTier});
...
class _BenchPressScreenState extends State<BenchPressScreen>
  ...
  static const List<String> _tips = [
    ...
    'Lower the bar slowly to your mid-chest with control.',
    'Drive the bar up explosively, fully locking out at the top.',
    'Keep your shoulder blades pinched together and retracted.',
  ];

  static const List<String> _commonMistakes = [
    'Bouncing the bar off the chest — use controlled descent.',
    'Flaring elbows out too wide — keep at 45–75 degrees.',
    'Lifting your feet — keep them firmly planted.',
  ...
  static const List<Map<String, dynamic>> _variations = [
    {
      ...
      'reps': 10,
      'rest': '60s',
      'desc': 'Standard middle chest builder',
    ...
    },
    {
      ...
      'reps': 10,
      'rest': '60s',
      'desc': 'Upper chest focus at 30–45° incline',
    ...
    },
    {
      ...
      'reps': 12,
      'rest': '60s',
      'desc': 'Lower chest focus — completes the chest shape',
    ...
    },
    {
      ...
      'reps': 12,
      'rest': '60s',
      'desc': 'Full range of motion — maximizes muscle stretch',
  ...
  Future<void> _logWorkout() async {
    ...
    try {
      ...
      final match = exercises.firstWhere(
        (e) => (e['name'] as String?)?.toLowerCase() == 'bench press',
        orElse: () => {},
      );
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text(
            success ? '✅ Bench Press logged!' : '⚠️ Could not log — try again'),
        backgroundColor:
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (_, index) {
          ...
          final isUnlocked = _isTierUnlocked(v['tier'] as String? ?? 'guest');
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Row(
                      children: [
                        Text(variation['emoji'] as String? ?? '🏋️',
